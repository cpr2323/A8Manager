...
{
    DefaultHelpers::setAndHandleDefault<juce::String> (data, NamePropertyId, name, includeSelfCallback, this, [this] () { return getNameDefault(); });
}
...
{
    return DefaultHelpers::getAndHandleDefault<juce::String> (data, NamePropertyId, [this] () { return getNameDefault (); });
}
